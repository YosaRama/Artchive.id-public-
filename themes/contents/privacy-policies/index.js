...
function ThemesContentsPrivacyPolicies() {
  return (
    <>
      <ThemesContainerMain>
        <Col style={{ margin: "50px auto 30px" }}>
          <ThemesHeadline title="PRIVACY POLICY" subtitle="Last updated : [ 8 April 2022 ]" />
        </Col>
        <Col xl={{ span: 12 }} lg={{ span: 16 }} style={{ margin: "30px auto 60px" }}>
          ...
          <p>
            ...
            <strong> Artchive.id </strong>website.
          </p>
          <p>
          ...
          <p>
            ...
            stored on your computer's hard drive. Our website uses these "cookies" to collection
...
export default ThemesContentsPrivacyPolicies;
