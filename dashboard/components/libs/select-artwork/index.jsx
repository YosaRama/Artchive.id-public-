...
function AppSelectArtwork(props) {
  const { setResult, selectBy = "id" } = props;
...
AppSelectArtwork.propTypes = {
  setResult: propTypes.func,
  selectBy: propTypes.oneOf(["sku", "id", "slug"]),
};

export default AppSelectArtwork;
