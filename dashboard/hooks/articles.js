...
const pathName = "/articles"; // End point
const msgHead = "Articles"; // Just For message

//? ============== INFINITE HOOK ============= ?//
export const useArticlesLoad = ({ limit = 15, queryString = "" }) => {
...
export const useArticles = ({ queryString = "" }) => {
...
export const useArticle = ({ singleId }) => {
